...
// 에너지 저장 정보 카드 데이터
const essData = [
  { label: '총 방전량', value: '0.664 MWh', color: '#22c55e' },
...
export default function ESSInfoCard() {
  return (
    <div className="border border-[#e4e4e7] rounded-2xl p-6 py-10 bg-white">
      <h2 className="text-xl font-bold text-[#0a112f] mb-8">에너지 저장 정보</h2>

      <div className="grid grid-cols-2 gap-x-6 gap-y-10">
        {essData.map((item, index) => (
